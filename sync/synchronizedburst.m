...
trainlength = 50; % in mss
dt=(1/frequencies);
pulsenum=round((trainlength/1000)/dt);
...
res = configureStimulusPattern(cerestim, 1, 'AF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
res = configureStimulusPattern(cerestim, 2, 'CF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
res = configureStimulusPattern(cerestim, 1, 'AF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
res = configureStimulusPattern(cerestim, 2, 'CF', pulsenum, ...
...
res = configureStimulusPattern(cerestim, 2, 'CF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
res = configureStimulusPattern(cerestim, 3, 'AF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
res = configureStimulusPattern(cerestim, 4, 'CF', pulsenum, ...
        stimamplitude, stimamplitude, 90, 90, frequencies, 53);
...
delete(cerestim);
fclose(logfile);
save(['C:\Stimulation\SyncBurstMulti',num2str(stimamplitude/1000),'maLocs-' filename],...
